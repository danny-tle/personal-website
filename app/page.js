...
export default function Home() {
  ...
  <div className="page-wrapper">
    <div className="page-container bg-white/60">
      {/* TODO(human): Choose delay values for each RevealSection below.
         Currently set to 0/150/300/450 to match the about page.
         Adjust these to control the staggered reveal timing (in ms). */}
